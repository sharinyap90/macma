				...
				<div class="fix">
					<div class="fix main_content floatright" >
						<div class="single_page_content fix" style="height:50%;">
							<center><h1 style="margin-bottom:70px;">Member Login</h1></center>
								<div class="col-md-8 col-md-offset-2 col-sm-offset-2">
									
									<center><form name="adminLogin" action = "memberLoginValidate.php" method = 'POST'>
										
										<div class="input-group" style=" margin: 0 0 20px 0;">
											<span class="input-group-addon">
												<i class="glyphicon glyphicon-user"></i>
											</span>
											<input placeholder="Username" class="form-control" type="text" name="memberUsername">
										</div>
										...
										<br/>
										<div class="col-md-12">
										<input type="submit" class="submit btn-primary" value="Submit" style="margin:0 0 0 70%;"/>
										</div>
