			...
			<div class="fix wrap content_wrapper">
				...
				<div class="fix">
						<div class="single_page_content fix" >
							<center><h1 style="margin-bottom:15px;">Generate Report</h1></center>
								<hr>
									...
									<form id="" method="post" class="form-horizontal">
											...
											<div class="form-group">
											 ...
											 <select class="form-control" required>
												  ...
												  <option value="member">List of Member</option>
												  <option value="contribution">List of Contribution Report</option>
													<option value="visit">Visit Information Report</option>
